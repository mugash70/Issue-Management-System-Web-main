                    ...
                    <div className="row">
                        <div className="col s12 m5">
                            <div className="card-panel ">
                                ...
                                <Link className="btn-floating btn-large deep-purple" to="/Administrator/user/Issues" ><i class="material-icons">add</i></Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card w-50">
                    <div className="card-body">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">No of Organisations:1000
                            {/* {noEmployee} */}
                            </li>
                        </ul>
                    </div>
