...
class UpdateSu extends Component {
    static propTypes = {
    ...
    render() {
        ...
        return (
            <div>
                <Navb />
                <div className="col d-flex justify-content-center ml-5 " style={{ marginTop: '-30px' }}>{Profile}</div>
            </div>
        )
    }
}
...
export default connect(mapStateToProps, { updateOrg, findErrors })(UpdateSu)