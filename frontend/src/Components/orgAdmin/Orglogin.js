...
import { Orglogin } from '../../actions/orgAuthActions'
...
class Login extends Component {
    ...
    static propTypes = {
        ...
        Orglogin: propTypes.func.isRequired
    }
    state = {
        password: '',
        email: '',
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.auth.isAuthenticated) {
            ...
            this.props.history.push(`/Organisation/user/${user.id}`)
        }
    }
    componentWillMount() {
                            ...
                            <div className="card " style={{ marginTop: "50px", float: "none" }}>
                                <div className="card-content">
                                    <Form onSubmit={this.handleLogin}>
                                        <h3 className="center" >Organisation</h3>
                                        ...
                                        <div className="center ">
                                            <Button className=" white-text  accent-4 red"  >Login</Button>
...
export default connect(mapStateToProps, { Orglogin, findErrors, clearError })(Login)